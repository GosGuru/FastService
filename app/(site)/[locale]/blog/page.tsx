...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	return {
		...
		description: uiLabels[locale].blogMetadataDescription,
		...
		<main className="section page-offset">
			<div className="container">
				...
				<div className="content-grid content-grid--three">
					{posts.map((post) => (
						<Link
							href={`/${locale}/blog/${getLocalizedSlug(post.slugsByLocale, locale)}`}
							className="post-card"
							key={post.id}
						>
							<span className="post-card__image">
								<MediaImage asset={post.image} locale={locale} />
							</span>
